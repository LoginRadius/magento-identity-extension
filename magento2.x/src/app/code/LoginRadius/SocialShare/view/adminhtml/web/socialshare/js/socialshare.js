require(['jquery', 'jquery/ui'], function ($) {
    ...
    function socialProvidersChecked(theme, type) {
        if (type == 'share') {
            var horizontalRearrange = $('#lrsocialshare_' + theme + '_share_rearrange_icons').val().split("|");
            rearrangeProviders(theme);
        } else if (type == 'count') {
            var horizontalRearrange = $('#lrsocialshare_' + theme + '_share_counter_provider_theme').val().split("|");
        }
